...
public class EjerciciosVector3_3 : MonoBehaviour
{
    [SerializeField]
    ...
    void OnDrawGizmos()
    {
        ...
        Handles.Label(new Vector3(VectorC.x + 2, VectorC.y - 4, VectorC.z), "Y = " + VectorC.y);
        Handles.Label(new Vector3(VectorC.x + 2, VectorC.y - 8, VectorC.z), "Z = " + VectorC.z);
